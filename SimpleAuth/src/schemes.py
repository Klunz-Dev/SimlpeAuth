...
class CreateUser(BaseModel):
    first_name: str = Field(..., title="You'r name (min: 1, max: 16)", min_length=1, max_length=16)
    username: str = Field(..., title="You'r username (min: 1, max: 16)", min_length=1, max_length=16)
